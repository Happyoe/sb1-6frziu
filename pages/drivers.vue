<template>
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="ride in rides" :key="ride.id" class="bg-purple-800 p-6 rounded-lg shadow-lg">
        ...
        <button @click="bookRide(ride.id)" class="mt-4 bg-yellow-400 text-purple-900 px-4 py-2 rounded font-bold hover:bg-yellow-300 transition-colors">
          Book Ride
        </button>
      </div>
    </div>
